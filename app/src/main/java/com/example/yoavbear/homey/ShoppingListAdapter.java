...
public class ShoppingListAdapter extends RecyclerView.Adapter<ShoppingListAdapter.MyViewHolder> {
    ...
    public ShoppingListAdapter(Context context, @Nullable ArrayList<ShoppingListItem> data, String currentLoggedInUser, boolean isCompletedChore) {
    ...
    public void updateList(ArrayList<ShoppingListItem> data) {
        this.data = data;
    ...
    public ShoppingListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ShoppingListAdapter.MyViewHolder holder = new ShoppingListAdapter.MyViewHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(final ShoppingListAdapter.MyViewHolder holder, int position) {
        if (position < data.size()) {
            final ShoppingListItem current = data.get(position);
...
//            holder.deleteChoreBtn.setText("DELETE CHORE");
            ...
            holder.completeChoreBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final DatabaseReference dRaffChores = FirebaseDatabase.getInstance().getReference().child("Households").child(user_id).child("ShoppingListItems").child(current.getCreator()).child(current.getTitle());
